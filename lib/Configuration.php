...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2023.10.0.231113/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2023_10) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2023-10' . PHP_EOL;
        $report .= '    SDK Package Version: 2023.10.0.231113' . PHP_EOL;
