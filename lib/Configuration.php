...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2023.04.0.230601/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2023_04) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2023-04' . PHP_EOL;
        $report .= '    SDK Package Version: 2023.04.0.230601' . PHP_EOL;
