...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2024.01.0.240207/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2024_01) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2024-01' . PHP_EOL;
        $report .= '    SDK Package Version: 2024.01.0.240207' . PHP_EOL;
