...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2025.10.0.251216/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2025_10) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2025-10' . PHP_EOL;
        $report .= '    SDK Package Version: 2025.10.0.251216' . PHP_EOL;
