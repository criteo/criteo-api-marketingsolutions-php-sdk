...
namespace criteo\api\marketingsolutions\v2026_01;
...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2026.01.0.260623/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2026_01) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2026-01' . PHP_EOL;
        $report .= '    SDK Package Version: 2026.01.0.260623' . PHP_EOL;
