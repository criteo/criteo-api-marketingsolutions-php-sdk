...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2025.04.0.260622/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2025_04) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2025-04' . PHP_EOL;
        $report .= '    SDK Package Version: 2025.04.0.260622' . PHP_EOL;
