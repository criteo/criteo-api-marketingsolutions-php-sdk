...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2022.10.0.230726/PHP';
    ...
    {
        $report  = 'PHP SDK (criteo\api\marketingsolutions\v2022_10) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2022-10' . PHP_EOL;
        $report .= '    SDK Package Version: 2022.10.0.230726' . PHP_EOL;
