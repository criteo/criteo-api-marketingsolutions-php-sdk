...
class PatchAdSetScheduledBudgetUpdateV26Q1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchAdSetScheduledBudgetUpdateV26Q1';
    ...
    protected static $openAPITypes = [
        'budget_amount' => '\criteo\api\marketingsolutions\experimental\Model\NillableDecimal',
    ...
    */
     ...
     * Sets budget_amount
     *
     * @param \criteo\api\marketingsolutions\experimental\Model\NillableDecimal|null $budget_amount budget_amount
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Identifier of the scheduled budget to update.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date New advertiser-local calendar date when the scheduled budget becomes active. Must be strictly in the future  and unique among the ad set's scheduled budgets.
     *
     * @return self
     */
