...
/**
 * CreateProductFilterRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateProductFilterRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateProductFilterRequest';
    ...
    */
    ...
    public function setProductSetId($product_set_id)
    {
        if (is_null($product_set_id)) {
            array_push($this->openAPINullablesSetToNull, 'product_set_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('product_set_id', $nullablesSetToNull);
            if ($index !== FALSE) {
