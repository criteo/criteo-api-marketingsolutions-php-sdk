...
/**
 * CreateAdSetAttributionConfigurationV26Q1 Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateAdSetAttributionConfigurationV26Q1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAdSetAttributionConfigurationV26Q1';
    ...
    */
    ...
    public function setAttributionMethod($attribution_method)
    {
        if (is_null($attribution_method)) {
            throw new \InvalidArgumentException('non-nullable attribution_method cannot be null');
        }
        $allowedValues = $this->getAttributionMethodAllowableValues();
        if (!in_array($attribution_method, $allowedValues, true)) {
