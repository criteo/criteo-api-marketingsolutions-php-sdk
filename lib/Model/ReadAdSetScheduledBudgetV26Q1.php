...
/**
 * ReadAdSetScheduledBudgetV26Q1 Class Doc Comment
 *
 * @category Class
 * @description A budget configuration scheduled to replace the ad set&#39;s active budget on the specified \&quot;startDate\&quot;.  It contains the same fields as the active budget, plus the scheduled budget identifier and start date.
 * @package  criteo\api\marketingsolutions\experimental
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReadAdSetScheduledBudgetV26Q1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReadAdSetScheduledBudgetV26Q1';
    ...
    */
     ...
     * Sets budget_amount
     *
     * @param float|null $budget_amount Maximum budget amount in the advertiser's currency per renewal period. Non-null when capped. null when uncapped.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Identifier of the scheduled budget.
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date Advertiser-local calendar date when the scheduled budget becomes active.
     *
     * @return self
     */
