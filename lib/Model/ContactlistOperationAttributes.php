...
class ContactlistOperationAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['contact_list_id'] = $data['contact_list_id'] ?? null;
        ...
        $this->container['nb_valid_identifiers'] = $data['nb_valid_identifiers'] ?? null;
        $this->container['nb_invalid_identifiers'] = $data['nb_invalid_identifiers'] ?? null;
        $this->container['sample_invalid_identifiers'] = $data['sample_invalid_identifiers'] ?? null;
    }
