    ...
    */
    ...
    public function setExtraInfos($extra_infos)
    {
        if (is_null($extra_infos)) {
            array_push($this->openAPINullablesSetToNull, 'extra_infos');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('extra_infos', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets products
     *
     * @return \criteo\api\marketingsolutions\experimental\Model\RecommendedProduct[]|null
     */
     ...
     * Sets products
     *
     * @param \criteo\api\marketingsolutions\experimental\Model\RecommendedProduct[]|null $products Recommended products
     *
     * @return self
     */
