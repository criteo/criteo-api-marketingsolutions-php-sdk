...
class RetargetingCreateV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['days_since_last_visit_max'] === null) {
            $invalidProperties[] = "'days_since_last_visit_max' can't be null";
        }
        if ($this->container['days_since_last_visit_min'] === null) {
            $invalidProperties[] = "'days_since_last_visit_min' can't be null";
        }
        if ($this->container['visitors_type'] === null) {
            $invalidProperties[] = "'visitors_type' can't be null";
        }
     ...
     *
     * @param int $days_since_last_visit_max Maximum number of days since last visit to partner.
     *
     * @return self
     */
     ...
     *
     * @param int $days_since_last_visit_min Minimum number of days since last visit to partner.
     *
     * @return self
     */
     ...
     * Sets visitors_type
     *
     * @param string $visitors_type Types of visitors.
     *
     * @return self
     */
