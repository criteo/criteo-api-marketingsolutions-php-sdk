...
/**
 * ReportDetailWarning Class Doc Comment
 *
 * @category Class
 ...
 */
class ReportDetailWarning implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReportDetailWarning';
    ...
    public const TYPE_OVERLARGE_BADGE_URL = 'OverlargeBadgeUrl';
    public const TYPE_INVALID_BADGE_URL = 'InvalidBadgeUrl';
    ...
    {
        return [
            self::TYPE_OVERLARGE_BADGE_URL,
            self::TYPE_INVALID_BADGE_URL,
        ];
    }
