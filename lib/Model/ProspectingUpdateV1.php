...
class ProspectingUpdateV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'days_since_last_visit_min' => '\criteo\api\marketingsolutions\v2023_10\Model\NillableInt32',
        'days_since_last_visit_max' => '\criteo\api\marketingsolutions\v2023_10\Model\NillableInt32',
        'users_type' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \criteo\api\marketingsolutions\v2023_10\Model\NillableInt32|null
     */
     ...
     *
     * @param \criteo\api\marketingsolutions\v2023_10\Model\NillableInt32|null $days_since_last_visit_min days_since_last_visit_min
     *
     * @return self
     */
     ...
     *
     * @param \criteo\api\marketingsolutions\v2023_10\Model\NillableInt32|null $days_since_last_visit_max days_since_last_visit_max
     *
     * @return self
     */
    ...
    public function setUsersType($users_type)
    {
        if (is_null($users_type)) {
            array_push($this->openAPINullablesSetToNull, 'users_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('users_type', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $allowedValues = $this->getUsersTypeAllowableValues();
        if (!is_null($users_type) && !in_array($users_type, $allowedValues, true)) {
