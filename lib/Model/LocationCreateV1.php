...
class LocationCreateV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'points_of_interest' => '\criteo\api\marketingsolutions\v2025_04\Model\PointOfInterestV1[]',
        'radius_in_km' => 'int'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['points_of_interest'] === null) {
            $invalidProperties[] = "'points_of_interest' can't be null";
        }
        if ($this->container['radius_in_km'] === null) {
            $invalidProperties[] = "'radius_in_km' can't be null";
        }
     ...
     *
     * @return \criteo\api\marketingsolutions\v2025_04\Model\PointOfInterestV1[]
     */
     ...
     *
     * @param \criteo\api\marketingsolutions\v2025_04\Model\PointOfInterestV1[] $points_of_interest Reach users which have been historically located in the given coordinates
     *
     * @return self
     */
     ...
     * Sets radius_in_km
     *
     * @param int $radius_in_km The expected maximum distance in kilometers between a user and a point of interest
     *
     * @return self
     */
