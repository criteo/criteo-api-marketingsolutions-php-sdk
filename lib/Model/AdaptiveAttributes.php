...
class AdaptiveAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const LAYOUTS_EDITORIAL = 'Editorial';
    const LAYOUTS_MONTAGE = 'Montage';
    const LAYOUTS_IN_BANNER_VIDEO = 'InBannerVideo';
    const IMAGE_DISPLAY_SHOW_FULL_IMAGE = 'ShowFullImage';
    const IMAGE_DISPLAY_ZOOM_ON_IMAGE = 'ZoomOnImage';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['image_sets'] = $data['image_sets'] ?? null;
