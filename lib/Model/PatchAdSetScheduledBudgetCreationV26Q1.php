...
class PatchAdSetScheduledBudgetCreationV26Q1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchAdSetScheduledBudgetCreationV26Q1';
    ...
    */
     ...
     * Sets budget_amount
     *
     * @param float|null $budget_amount Maximum budget amount in the advertiser's currency per renewal period.  Required when budgetStrategy is \"capped\"; must be omitted when budgetStrategy is \"uncapped\".
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime $start_date Advertiser-local calendar date when the scheduled budget becomes active. Required, strictly in the future.
     *
     * @return self
     */
