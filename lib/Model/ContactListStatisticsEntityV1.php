    ...
    */
    ...
    public function setNumberOfIdentifiers($number_of_identifiers)
    {
        if (is_null($number_of_identifiers)) {
            array_push($this->openAPINullablesSetToNull, 'number_of_identifiers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('number_of_identifiers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setNumberOfMatches($number_of_matches)
    {
        if (is_null($number_of_matches)) {
            array_push($this->openAPINullablesSetToNull, 'number_of_matches');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('number_of_matches', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
