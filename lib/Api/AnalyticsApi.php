...
class AnalyticsApi
{
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\StatisticsReportQueryMessage $statistics_report_query_message statistics_report_query_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\StatisticsReportQueryMessage $statistics_report_query_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdsetReportWithHttpInfo($statistics_report_query_message = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdsetReportRequest($statistics_report_query_message = null)
    {
        ...
        $resourcePath = '/2022-04/statistics/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\PlacementsReportQueryDataMessage $placements_report_query_data_message placements_report_query_data_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\PlacementsReportQueryDataMessage $placements_report_query_data_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
    ...
    public function getPlacementsReportRequest($placements_report_query_data_message = null)
    {
        ...
        $resourcePath = '/2022-04/placements/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\TransactionsReportQueryDataMessage $transactions_report_query_data_message transactions_report_query_data_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\TransactionsReportQueryDataMessage $transactions_report_query_data_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
    ...
    public function getTransactionsReportRequest($transactions_report_query_data_message = null)
    {
        ...
        $resourcePath = '/2022-04/transactions/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\TransparencyQueryMessage $transparency_query_message transparency_query_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage
     */
     ...
     *
     * @param  int $advertiser_id The advertiser id to fetch the transparency data. (required)
     * @param  \criteo\api\marketingsolutions\v2022_04\Model\TransparencyQueryMessage $transparency_query_message (optional)
     *
     * @throws \criteo\api\marketingsolutions\v2022_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage|\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTransparencyReportWithHttpInfo($advertiser_id, $transparency_query_message = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getTransparencyReportRequest($advertiser_id, $transparency_query_message = null)
    {
        ...
        $resourcePath = '/2022-04/log-level/advertisers/{advertiser-id}/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
