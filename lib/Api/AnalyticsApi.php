            ...
            switch($statusCode) {
                ...
                case 400:
                    if ('\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2022_04\Model\ErrorMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2022_04\Model\TransparencyReportDataMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
