...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2023_10\Model\StatisticsReportQueryMessage $statistics_report_query_message statistics_report_query_message (optional)
     ...
     * @return string|\criteo\api\marketingsolutions\v2023_10\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2023_10\Model\ProblemsDetails
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2023_10\Model\StatisticsReportQueryMessage $statistics_report_query_message (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAdsetReport'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2023_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\criteo\api\marketingsolutions\v2023_10\Model\ProblemsDetails|\criteo\api\marketingsolutions\v2023_10\Model\ProblemsDetails, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getAdsetReportRequest($statistics_report_query_message = null, string $contentType = self::contentTypes['getAdsetReport'][0])
    {
        ...
        $resourcePath = '/2023-10/statistics/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getPlacementsReportRequest($placements_report_query_data_message = null, string $contentType = self::contentTypes['getPlacementsReport'][0])
    {
        ...
        $resourcePath = '/2023-10/placements/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getTransactionsReportRequest($transactions_report_query_data_message = null, string $contentType = self::contentTypes['getTransactionsReport'][0])
    {
        ...
        $resourcePath = '/2023-10/transactions/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getTransparencyReportRequest($advertiser_id, $transparency_query_message = null, string $contentType = self::contentTypes['getTransparencyReport'][0])
    {
        ...
        $resourcePath = '/2023-10/log-level/advertisers/{advertiser-id}/report';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
