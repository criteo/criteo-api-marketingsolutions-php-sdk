...
class CatalogApi
{
     ...
     */
    public function previewCatalogProductsBatchPost($products_custom_batch_request)
    {
        list($response) = $this->previewCatalogProductsBatchPostWithHttpInfo($products_custom_batch_request);
        return $response;
    }
     ...
     */
    public function previewCatalogProductsBatchPostWithHttpInfo($products_custom_batch_request)
    {
        $request = $this->previewCatalogProductsBatchPostRequest($products_custom_batch_request);
     ...
     */
    public function previewCatalogProductsBatchPostAsync($products_custom_batch_request)
    {
        return $this->previewCatalogProductsBatchPostAsyncWithHttpInfo($products_custom_batch_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewCatalogProductsBatchPostAsyncWithHttpInfo($products_custom_batch_request)
    {
        $returnType = '\criteo\api\marketingsolutions\preview\Model\BatchAcceptedResponse';
        $request = $this->previewCatalogProductsBatchPostRequest($products_custom_batch_request);
     ...
     */
    public function previewCatalogProductsBatchPostRequest($products_custom_batch_request)
    {
        ...
        if (isset($products_custom_batch_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($products_custom_batch_request));
            } else {
     ...
     */
    public function previewCatalogProductsBatchReportOperationTokenGet($operation_token)
    {
        list($response) = $this->previewCatalogProductsBatchReportOperationTokenGetWithHttpInfo($operation_token);
        return $response;
    }
     ...
     */
    public function previewCatalogProductsBatchReportOperationTokenGetWithHttpInfo($operation_token)
    {
        $request = $this->previewCatalogProductsBatchReportOperationTokenGetRequest($operation_token);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewCatalogProductsBatchReportOperationTokenGetAsync($operation_token)
    {
        return $this->previewCatalogProductsBatchReportOperationTokenGetAsyncWithHttpInfo($operation_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function previewCatalogProductsBatchReportOperationTokenGetAsyncWithHttpInfo($operation_token)
    {
        $returnType = '\criteo\api\marketingsolutions\preview\Model\ReportOkResponse';
        $request = $this->previewCatalogProductsBatchReportOperationTokenGetRequest($operation_token);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function previewCatalogProductsBatchReportOperationTokenGetRequest($operation_token)
    {
