...
/**
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\CreateAdSetV24Q3Request $create_ad_set_v24_q3_request the ad sets to create (required)
     ...
     * @return \criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAdSetWithHttpInfo($create_ad_set_v24_q3_request, string $contentType = self::contentTypes['createAdSet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\ResponseReadAdSetV24Q3',
    ...
    public function createAdSetRequest($create_ad_set_v24_q3_request, string $contentType = self::contentTypes['createAdSet'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\CreateCampaignRequest $create_campaign_request the campaigns to create (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCampaignWithHttpInfo($create_campaign_request, string $contentType = self::contentTypes['createCampaign'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createCampaignRequest($create_campaign_request, string $contentType = self::contentTypes['createCampaign'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * 
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\CreateSellerBudgetMapiMessage[] $create_seller_budget_mapi_message  (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function createMarketplaceSellerBudgetsWithHttpInfo($create_seller_budget_mapi_message, string $contentType = self::contentTypes['createMarketplaceSellerBudgets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\SellerBudgetMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createMarketplaceSellerBudgetsRequest($create_seller_budget_mapi_message, string $contentType = self::contentTypes['createMarketplaceSellerBudgets'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/budgets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\CreateSellerCampaignMessageMapi $create_seller_campaign_message_mapi Supply the campaign Id and bid to create the mapping (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function createMarketplaceSellerCampaignsBySellerWithHttpInfo($seller_id, $create_seller_campaign_message_mapi, string $contentType = self::contentTypes['createMarketplaceSellerCampaignsBySeller'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function createMarketplaceSellerCampaignsBySellerRequest($seller_id, $create_seller_campaign_message_mapi, string $contentType = self::contentTypes['createMarketplaceSellerCampaignsBySeller'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/sellers/{sellerId}/seller-campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getAdSetRequest($ad_set_id, string $contentType = self::contentTypes['getAdSet'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/{ad-set-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdSetCategoryBidsWithHttpInfo($ad_set_id, string $contentType = self::contentTypes['getAdSetCategoryBids'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdSetCategoryBidListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getAdSetCategoryBidsRequest($ad_set_id, string $contentType = self::contentTypes['getAdSetCategoryBids'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/{ad-set-id}/category-bids';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getCampaignRequest($campaign_id, string $contentType = self::contentTypes['getCampaign'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/campaigns/{campaign-id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDisplayMultipliersWithHttpInfo($ad_set_id, string $contentType = self::contentTypes['getDisplayMultipliers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdSetDisplayMultiplierListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getDisplayMultipliersRequest($ad_set_id, string $contentType = self::contentTypes['getDisplayMultipliers'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/{ad-set-id}/display-multipliers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceAdSetsByAdvertiserWithHttpInfo($advertiser_id, string $contentType = self::contentTypes['getMarketplaceAdSetsByAdvertiser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserAdsetMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceAdSetsByAdvertiserRequest($advertiser_id, string $contentType = self::contentTypes['getMarketplaceAdSetsByAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/adsets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceAdvertiserWithHttpInfo($advertiser_id, string $contentType = self::contentTypes['getMarketplaceAdvertiser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserInfoMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceAdvertiserRequest($advertiser_id, string $contentType = self::contentTypes['getMarketplaceAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceAdvertiserPreviewLimitsWithHttpInfo(string $contentType = self::contentTypes['getMarketplaceAdvertiserPreviewLimits'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserQuotaMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceAdvertiserPreviewLimitsRequest(string $contentType = self::contentTypes['getMarketplaceAdvertiserPreviewLimits'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/preview-limit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceAdvertisersRequest(string $contentType = self::contentTypes['getMarketplaceAdvertisers'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceBudgetsByAdvertiserRequest($advertiser_id, $budget_id = null, $end_after_date = null, $seller_id = null, $start_before_date = null, $status = null, $type = null, $with_balance = null, $with_spend = null, string $contentType = self::contentTypes['getMarketplaceBudgetsByAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/budgets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceBudgetsBySellerRequest($seller_id, $campaign_id = null, $end_after_date = null, $start_before_date = null, $status = null, $type = null, $with_balance = null, $with_spend = null, string $contentType = self::contentTypes['getMarketplaceBudgetsBySeller'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/sellers/{sellerId}/budgets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceBudgetsBySellerCampaignRequest($seller_campaign_id, $end_after_date = null, $start_before_date = null, $status = null, $type = null, $with_balance = null, $with_spend = null, string $contentType = self::contentTypes['getMarketplaceBudgetsBySellerCampaign'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/seller-campaigns/{sellerCampaignId}/budgets';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceCampaignsByAdvertiserWithHttpInfo($advertiser_id, string $contentType = self::contentTypes['getMarketplaceCampaignsByAdvertiser'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdvertiserCampaignMessage[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceCampaignsByAdvertiserRequest($advertiser_id, string $contentType = self::contentTypes['getMarketplaceCampaignsByAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceCampaignsStatsWithHttpInfo($advertiser_id = null, $campaign_id = null, $click_attribution_policy = 'AnySeller', $count = null, $end_date = null, $interval_size = 'Day', $start_date = null, $time_zone_id = null, string $contentType = self::contentTypes['getMarketplaceCampaignsStats'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\StatsReportMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceCampaignsStatsRequest($advertiser_id = null, $campaign_id = null, $click_attribution_policy = 'AnySeller', $count = null, $end_date = null, $interval_size = 'Day', $start_date = null, $time_zone_id = null, string $contentType = self::contentTypes['getMarketplaceCampaignsStats'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/stats/campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\SellerBase
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\SellerBase, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMarketplaceSellerWithHttpInfo($seller_id, string $contentType = self::contentTypes['getMarketplaceSeller'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerBase' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\SellerBase' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\SellerBase', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\SellerBase';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\SellerBase',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getMarketplaceSellerRequest($seller_id, string $contentType = self::contentTypes['getMarketplaceSeller'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/sellers/{sellerId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerAdPreviewRequest($advertiser_id, $seller_id, $campaign_id = null, $height = null, $width = null, string $contentType = self::contentTypes['getMarketplaceSellerAdPreview'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/ad-preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerBudgetRequest($budget_id, string $contentType = self::contentTypes['getMarketplaceSellerBudget'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/budgets/{budgetId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerCampaignRequest($seller_campaign_id, string $contentType = self::contentTypes['getMarketplaceSellerCampaign'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/seller-campaigns/{sellerCampaignId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerCampaignsRequest($advertiser_id = null, $budget_status = null, $campaign_id = null, $seller_id = null, $seller_status = null, string $contentType = self::contentTypes['getMarketplaceSellerCampaigns'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/seller-campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerCampaignsByAdvertiserRequest($advertiser_id, string $contentType = self::contentTypes['getMarketplaceSellerCampaignsByAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/seller-campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellerCampaignsStatsRequest($advertiser_id = null, $campaign_id = null, $click_attribution_policy = 'AnySeller', $count = null, $end_date = null, $interval_size = 'Day', $seller_id = null, $start_date = null, $time_zone_id = null, string $contentType = self::contentTypes['getMarketplaceSellerCampaignsStats'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/stats/seller-campaigns';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellersRequest($advertiser_id = null, $campaign_id = null, $seller_name = null, $seller_status = null, $with_budget_status = null, $with_products = null, string $contentType = self::contentTypes['getMarketplaceSellers'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellersByAdvertiserRequest($advertiser_id, $request_body, $partner_id = null, string $contentType = self::contentTypes['getMarketplaceSellersByAdvertiser'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/advertisers/{advertiserId}/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getMarketplaceSellersStatsRequest($advertiser_id = null, $click_attribution_policy = 'AnySeller', $count = null, $end_date = null, $interval_size = 'Day', $seller_id = null, $start_date = null, $time_zone_id = null, string $contentType = self::contentTypes['getMarketplaceSellersStats'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/marketplace-performance-outcomes/stats/sellers';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $ad_set_id Id of the Ad Set (required)
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidListRequest $patch_ad_set_category_bid_list_request Collection of category bids to update (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchAdSetCategoryBidsWithHttpInfo($ad_set_id, $patch_ad_set_category_bid_list_request, string $contentType = self::contentTypes['patchAdSetCategoryBids'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetCategoryBidResultListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\RequestsPatchAdSetV24Q3 $requests_patch_ad_set_v24_q3 List of adsets to patch. (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchAdSetsWithHttpInfo($requests_patch_ad_set_v24_q3, string $contentType = self::contentTypes['patchAdSets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetIdV24Q3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\PatchCampaignListRequest $patch_campaign_list_request List of campaigns to patch. (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchCampaignsWithHttpInfo($patch_campaign_list_request, string $contentType = self::contentTypes['patchCampaigns'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\PatchResultCampaignListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $ad_set_id Id of the Ad Set (required)
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierListRequest $patch_ad_set_display_multiplier_list_request List of display multiplier values to change (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function patchDisplayMultipliersWithHttpInfo($ad_set_id, $patch_ad_set_display_multiplier_list_request, string $contentType = self::contentTypes['patchDisplayMultipliers'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\PatchAdSetDisplayMultiplierResultListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\AdSetSearchRequestV24Q3 $ad_set_search_request_v24_q3 ad_set_search_request_v24_q3 (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\AdSetSearchRequestV24Q3 $ad_set_search_request_v24_q3 (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchAdSets'] to see the possible values for this operation
     *
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchAdSetsWithHttpInfo($ad_set_search_request_v24_q3 = null, string $contentType = self::contentTypes['searchAdSets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesReadAdSetV24Q3',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchAdSetsRequest($ad_set_search_request_v24_q3 = null, string $contentType = self::contentTypes['searchAdSets'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\CampaignSearchRequestV23Q1 $campaign_search_request_v23_q1 Filters for searching for campaigns (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCampaignsWithHttpInfo($campaign_search_request_v23_q1 = null, string $contentType = self::contentTypes['searchCampaigns'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\CampaignV23Q1ListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchCampaignsRequest($campaign_search_request_v23_q1 = null, string $contentType = self::contentTypes['searchCampaigns'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/campaigns/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\RequestsAdSetId $requests_ad_set_id All the ad sets to start (optional)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId, HTTP status code, HTTP response headers (array of strings)
     */
    public function startAdSetsWithHttpInfo($requests_ad_set_id = null, string $contentType = self::contentTypes['startAdSets'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\ResponsesAdSetId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function startAdSetsRequest($requests_ad_set_id = null, string $contentType = self::contentTypes['startAdSets'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/start';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\RequestsAdSetId $requests_ad_set_id All the ad sets to stop (optional)
    ...
    public function stopAdSetsRequest($requests_ad_set_id = null, string $contentType = self::contentTypes['stopAdSets'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/stop';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkInputEntityV1 $ad_set_audience_link_input_entity_v1 Ad set-Audience update request. (required)
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2026_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateAdSetAudienceWithHttpInfo($ad_set_id, $ad_set_audience_link_input_entity_v1, string $contentType = self::contentTypes['updateAdSetAudience'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2026_01\Model\AdSetAudienceLinkEntityV1Response',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function updateAdSetAudienceRequest($ad_set_id, $ad_set_audience_link_input_entity_v1, string $contentType = self::contentTypes['updateAdSetAudience'][0])
    {
        ...
        $resourcePath = '/2026-01/marketing-solutions/ad-sets/{ad-set-id}/audience';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $budget_id Id of the budget (required)
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\UpdateSellerBudgetMessageBase $update_seller_budget_message_base  (required)
     ...
     * 
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\UpdateSellerBudgetMessage[] $update_seller_budget_message  (required)
     ...
     * 
     *
     * @param  \criteo\api\marketingsolutions\v2026_01\Model\SellerCampaignUpdate[] $seller_campaign_update  (required)
