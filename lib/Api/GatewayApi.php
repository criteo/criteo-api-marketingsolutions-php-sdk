...
class GatewayApi
{
     ...
     * @return \criteo\api\marketingsolutions\v2021_07\Model\ApplicationSummaryModelResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2021_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2021_07\Model\ApplicationSummaryModelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrentApplicationWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2021_07\Model\ApplicationSummaryModelResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2021_07\Model\ApplicationSummaryModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2021_07\Model\ApplicationSummaryModelResponse';
