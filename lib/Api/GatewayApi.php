...
/**
     ...
     * @return \criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_01\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCurrentApplicationWithHttpInfo(string $contentType = self::contentTypes['getCurrentApplication'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_01\Model\ApplicationSummaryModelResponse';
    ...
    public function getCurrentApplicationRequest(string $contentType = self::contentTypes['getCurrentApplication'][0])
    {
        ...
        $resourcePath = '/2024-01/marketing-solutions/me';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
