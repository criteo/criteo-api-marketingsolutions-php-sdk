...
/**
    ...
    public function createAdvertiserAdRequest($advertiser_id, $resource_input_of_ad_write, string $contentType = self::contentTypes['createAdvertiserAd'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/ads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function createAdvertiserCouponRequest($advertiser_id, $resource_input_of_create_coupon, string $contentType = self::contentTypes['createAdvertiserCoupon'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/coupons';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function createAdvertiserCreativeRequest($advertiser_id, $resource_input_of_creative_write, string $contentType = self::contentTypes['createAdvertiserCreative'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/creatives';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteAdRequest($id, string $contentType = self::contentTypes['deleteAd'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/ads/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteAdvertiserCouponRequest($advertiser_id, $id, string $contentType = self::contentTypes['deleteAdvertiserCoupon'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function deleteCreativeRequest($id, string $contentType = self::contentTypes['deleteCreative'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/creatives/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function generateCreativePreviewRequest($id, $height = null, $width = null, string $contentType = self::contentTypes['generateCreativePreview'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/creatives/{id}/preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getAdvertiserCouponPreviewRequest($advertiser_id, $id, $height = null, $width = null, string $contentType = self::contentTypes['getAdvertiserCouponPreview'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/coupons/{id}/preview';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getAdvertiserCouponSupportedSizesRequest($advertiser_id, $ad_set_id = null, string $contentType = self::contentTypes['getAdvertiserCouponSupportedSizes'][0])
    {
        ...
        $resourcePath = '/2024-07/marketing-solutions/advertisers/{advertiser-id}/coupons-supported-sizes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \criteo\api\marketingsolutions\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2024_07\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCreativesWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCreatives'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2024_07\Model\ResourceCollectionOutcomeOfCreativeRead',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
