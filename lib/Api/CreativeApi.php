...
class CreativeApi
{
     ...
     * @return string
     */
    public function getCreativePreview($id, $width = null, $height = null)
    {
        list($response) = $this->getCreativePreviewWithHttpInfo($id, $width, $height);
        return $response;
    }

    /**
     * Operation getCreativePreviewWithHttpInfo
     *
     * @param  string $id The Creative identifier to preview. (required)
     * @param  int $width The width of the Creative to preview. (optional)
     * @param  int $height The height of the Creative to preview. (optional)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCreativePreviewWithHttpInfo($id, $width = null, $height = null)
    {
        $request = $this->getCreativePreviewRequest($id, $width, $height);
    ...
    /**
     * Operation getCreativePreviewAsync
     *
     * @param  string $id The Creative identifier to preview. (required)
     * @param  int $width The width of the Creative to preview. (optional)
     * @param  int $height The height of the Creative to preview. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreativePreviewAsync($id, $width = null, $height = null)
    {
        return $this->getCreativePreviewAsyncWithHttpInfo($id, $width, $height)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCreativePreviewAsyncWithHttpInfo
     *
     * @param  string $id The Creative identifier to preview. (required)
     * @param  int $width The width of the Creative to preview. (optional)
     * @param  int $height The height of the Creative to preview. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCreativePreviewAsyncWithHttpInfo($id, $width = null, $height = null)
    {
        $returnType = 'string';
        $request = $this->getCreativePreviewRequest($id, $width, $height);
    ...
    /**
     * Create request for operation 'getCreativePreview'
     *
     * @param  string $id The Creative identifier to preview. (required)
     * @param  int $width The width of the Creative to preview. (optional)
     * @param  int $height The height of the Creative to preview. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCreativePreviewRequest($id, $width = null, $height = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getCreativePreview'
            );
        }
