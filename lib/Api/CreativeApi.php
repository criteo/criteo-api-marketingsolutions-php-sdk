...
/**
     ...
     *
     * @param  string $advertiser_id The advertiser identifier. (required)
     * @param  \criteo\api\marketingsolutions\experimental\Model\ResourceInputOfCreateCoupon $resource_input_of_create_coupon The coupon to create. (required)
     ...
     * @param  \criteo\api\marketingsolutions\experimental\Model\ResourceInputOfUpdateCoupon $resource_input_of_update_coupon The new start and end dates of the coupon. (required)
     ...
     * @param  \criteo\api\marketingsolutions\experimental\Model\ResourceInputOfCreativeWrite $resource_input_of_creative_write The complete new attributes of the creative. (required)
