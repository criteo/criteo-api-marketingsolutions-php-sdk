...
/**
     ...
     * @throws \criteo\api\marketingsolutions\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2025_04\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAdvertiserCreativesWithHttpInfo($advertiser_id, $limit = null, $offset = null, string $contentType = self::contentTypes['getAdvertiserCreatives'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
