            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\NewAudienceResponse' === '\SplFileObject') {
                        ...
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\NewAudienceResponse' !== 'string') {
                ...
                case 403:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\ErrorCodeResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\ErrorCodeResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\DeleteAudienceContactListResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\DeleteAudienceContactListResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\GetAudiencesResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\GetAudiencesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\ReplaceAudienceResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\ReplaceAudienceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\ModifyAudienceResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\ModifyAudienceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2023_01\Model\DeleteAudienceResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\criteo\api\marketingsolutions\v2023_01\Model\DeleteAudienceResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
