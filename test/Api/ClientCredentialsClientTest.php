...
use criteo\api\marketingsolutions\v2021_07\Configuration;
...
use criteo\api\marketingsolutions\v2021_07\Model\AccessTokenModel;
...
class ClientCredentialsClientTest extends TestCase
{
    ...
    public function testDoesNotInterceptRequestWhenNoAuthorizationHeader()
    {
        ...
        $response = (new criteo\api\marketingsolutions\v2021_07\Api\OAuthApi($mockClient))
