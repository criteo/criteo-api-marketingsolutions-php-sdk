...
use criteo\api\marketingsolutions\v2022_04\Api\GatewayApi;
use criteo\api\marketingsolutions\v2022_04\ClientCredentialsClient;
        ...
        $this->assertThrows(ApiException::class, 
            ...
            function($exception) {
                $data = ObjectSerializer::deserialize(
                    ...
                    '\criteo\api\marketingsolutions\v2022_04\Model\ApplicationSummaryModelResponse',
