...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:0.0.220624`
...
*RecoApi* | [**fetchProductSets**](docs/Api/RecoApi.md#fetchproductsets) | **GET** /preview/product-sets/partner/{partner-id} | 
