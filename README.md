...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:0.0.260406`
...
*AnalyticsApi* | [**createRealtimeProductReport**](docs/Api/AnalyticsApi.md#createrealtimeproductreport) | **POST** /preview/marketing-solutions/marketplace-performance-outcomes/stats/realtime-reports/export | 
...
*AnalyticsApi* | [**getRealtimeProduct**](docs/Api/AnalyticsApi.md#getrealtimeproduct) | **GET** /preview/marketing-solutions/marketplace-performance-outcomes/stats/realtime-reports/{reportId} | 
*AnalyticsApi* | [**getRealtimeProductJob**](docs/Api/AnalyticsApi.md#getrealtimeproductjob) | **GET** /preview/marketing-solutions/marketplace-performance-outcomes/stats/report-jobs/{reportId} | 
...
*OnSiteRecommendationApi* | [**searchRecommendedProductsConversational**](docs/Api/OnSiteRecommendationApi.md#searchrecommendedproductsconversational) | **POST** /preview/recommendation/search-conversational | 
*RecoApi* | [**createBoostedAdAssociation**](docs/Api/RecoApi.md#createboostedadassociation) | **POST** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
*RecoApi* | [**createProductSet**](docs/Api/RecoApi.md#createproductset) | **POST** /preview/product-sets | 
*RecoApi* | [**deleteBoostedAdAssociation**](docs/Api/RecoApi.md#deleteboostedadassociation) | **DELETE** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
...
*RecoApi* | [**fetchBoostedAdAssociation**](docs/Api/RecoApi.md#fetchboostedadassociation) | **GET** /preview/marketing-solutions/ads/{ad-id}/product-boost/{product-set-id} | 
*RecoApi* | [**fetchBoostedAdAssociationByPartnerId**](docs/Api/RecoApi.md#fetchboostedadassociationbypartnerid) | **GET** /preview/marketing-solutions/dataset/{dataset-id}/product-boost | 
*RecoApi* | [**fetchBoostedAdAssociations**](docs/Api/RecoApi.md#fetchboostedadassociations) | **GET** /preview/marketing-solutions/ads/{ad-id}/product-boost | 
