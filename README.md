...
- Package version: 2023.01.0.230405
...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:2023.01.0.230405`
...
$apiInstance = new criteo\api\marketingsolutions\v2023_01\Api\AdvertiserApi(new criteo\api\marketingsolutions\v2023_01\TokenAutoRefreshClient($clientId, $clientSecret));
