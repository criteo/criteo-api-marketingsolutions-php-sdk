...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:0.0.251229`
...
------------ | ------------- | ------------- | -------------
*AdvertiserApi* | [**listAdvertisers**](docs/Api/AdvertiserApi.md#listadvertisers) | **GET** /preview/advertisers/me | 
*AdvertiserApi* | [**listDatasetsByAdvertiser**](docs/Api/AdvertiserApi.md#listdatasetsbyadvertiser) | **GET** /preview/advertisers/{advertiser-id}/datasets | 
...
*AudienceApi* | [**createAudienceSegments**](docs/Api/AudienceApi.md#createaudiencesegments) | **POST** /preview/marketing-solutions/audience-segments/create | 
*AudienceApi* | [**createAudiences**](docs/Api/AudienceApi.md#createaudiences) | **POST** /preview/marketing-solutions/audiences/create | 
*AudienceApi* | [**deleteAudienceSegments**](docs/Api/AudienceApi.md#deleteaudiencesegments) | **POST** /preview/marketing-solutions/audience-segments/delete | 
*AudienceApi* | [**deleteAudiences**](docs/Api/AudienceApi.md#deleteaudiences) | **POST** /preview/marketing-solutions/audiences/delete | 
*AudienceApi* | [**deleteContactListByAudienceSegment**](docs/Api/AudienceApi.md#deletecontactlistbyaudiencesegment) | **DELETE** /preview/marketing-solutions/audience-segments/{audience-segment-id}/contact-list | 
*AudienceApi* | [**estimateAudienceSegmentsSizes**](docs/Api/AudienceApi.md#estimateaudiencesegmentssizes) | **POST** /preview/marketing-solutions/audience-segments/estimate-size | 
*AudienceApi* | [**estimateAudiencesSizes**](docs/Api/AudienceApi.md#estimateaudiencessizes) | **POST** /preview/marketing-solutions/audiences/estimate-size | 
*AudienceApi* | [**getAudienceSegmentContactListStatistics**](docs/Api/AudienceApi.md#getaudiencesegmentcontactliststatistics) | **GET** /preview/marketing-solutions/audience-segments/{audience-segment-id}/contact-list/statistics | 
...
*AudienceApi* | [**modifyAudienceUsersWithAttributes**](docs/Api/AudienceApi.md#modifyaudienceuserswithattributes) | **PATCH** /preview/marketing-solutions/audiences/{audience-id}/contactlist-attributes | 
...
*AudienceApi* | [**updateAudienceSegments**](docs/Api/AudienceApi.md#updateaudiencesegments) | **PATCH** /preview/marketing-solutions/audience-segments | 
*AudienceApi* | [**updateAudiences**](docs/Api/AudienceApi.md#updateaudiences) | **PATCH** /preview/marketing-solutions/audiences | 
*AudienceApi* | [**updateContactListByAudienceSegment**](docs/Api/AudienceApi.md#updatecontactlistbyaudiencesegment) | **PATCH** /preview/marketing-solutions/audience-segments/{audience-segment-id}/contact-list | 
...
*CampaignApi* | [**getAdSet**](docs/Api/CampaignApi.md#getadset) | **GET** /preview/marketing-solutions/ad-sets/{ad-set-id} | 
*CampaignApi* | [**getAdSetCategoryBids**](docs/Api/CampaignApi.md#getadsetcategorybids) | **GET** /preview/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
...
*CampaignApi* | [**patchAdSetCategoryBids**](docs/Api/CampaignApi.md#patchadsetcategorybids) | **PATCH** /preview/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
...
*CatalogApi* | [**getCatalogMerchantStats**](docs/Api/CatalogApi.md#getcatalogmerchantstats) | **GET** /preview/catalog/stats/merchants/{merchant-id} | 
*CatalogApi* | [**getCatalogProductsBatchReport**](docs/Api/CatalogApi.md#getcatalogproductsbatchreport) | **GET** /preview/catalog/products/batch/report/{operation-token} | 
*CatalogApi* | [**submitCatalogProductsBatch**](docs/Api/CatalogApi.md#submitcatalogproductsbatch) | **POST** /preview/catalog/products/batch | 
...
*CreativeApi* | [**deleteAdSegmentLink**](docs/Api/CreativeApi.md#deleteadsegmentlink) | **DELETE** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
...
*CreativeApi* | [**getAdSegmentLink**](docs/Api/CreativeApi.md#getadsegmentlink) | **GET** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
...
*CreativeApi* | [**linkAdSegment**](docs/Api/CreativeApi.md#linkadsegment) | **PUT** /preview/marketing-solutions/ads/{ad-id}/audience-segment | 
*GatewayApi* | [**getCurrentApplication**](docs/Api/GatewayApi.md#getcurrentapplication) | **GET** /preview/marketing-solutions/me | 
*OnSiteRecommendationApi* | [**searchRecommendedProducts**](docs/Api/OnSiteRecommendationApi.md#searchrecommendedproducts) | **POST** /preview/recommendation/search | 
...
*RecoApi* | [**patchProductSet**](docs/Api/RecoApi.md#patchproductset) | **PATCH** /preview/product-sets/{product-set-id} | 
