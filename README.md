...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:2024.10.0.260112`
...
------------ | ------------- | ------------- | -------------
*AdvertiserApi* | [**listAdvertisers**](docs/Api/AdvertiserApi.md#listadvertisers) | **GET** /2024-10/advertisers/me | 
...
*AudienceApi* | [**createAudienceSegments**](docs/Api/AudienceApi.md#createaudiencesegments) | **POST** /2024-10/marketing-solutions/audience-segments/create | 
*AudienceApi* | [**createAudiences**](docs/Api/AudienceApi.md#createaudiences) | **POST** /2024-10/marketing-solutions/audiences/create | 
*AudienceApi* | [**deleteAudienceSegments**](docs/Api/AudienceApi.md#deleteaudiencesegments) | **POST** /2024-10/marketing-solutions/audience-segments/delete | 
*AudienceApi* | [**deleteAudiences**](docs/Api/AudienceApi.md#deleteaudiences) | **POST** /2024-10/marketing-solutions/audiences/delete | 
*AudienceApi* | [**estimateAudienceSegmentsSizes**](docs/Api/AudienceApi.md#estimateaudiencesegmentssizes) | **POST** /2024-10/marketing-solutions/audience-segments/estimate-size | 
*AudienceApi* | [**estimateAudiencesSizes**](docs/Api/AudienceApi.md#estimateaudiencessizes) | **POST** /2024-10/marketing-solutions/audiences/estimate-size | 
...
*AudienceApi* | [**updateAudienceSegments**](docs/Api/AudienceApi.md#updateaudiencesegments) | **PATCH** /2024-10/marketing-solutions/audience-segments | 
*AudienceApi* | [**updateAudiences**](docs/Api/AudienceApi.md#updateaudiences) | **PATCH** /2024-10/marketing-solutions/audiences | 
*CampaignApi* | [**createAdSet**](docs/Api/CampaignApi.md#createadset) | **POST** /2024-10/marketing-solutions/ad-sets | 
*CampaignApi* | [**createCampaign**](docs/Api/CampaignApi.md#createcampaign) | **POST** /2024-10/marketing-solutions/campaigns | 
*CampaignApi* | [**getAdSet**](docs/Api/CampaignApi.md#getadset) | **GET** /2024-10/marketing-solutions/ad-sets/{ad-set-id} | 
*CampaignApi* | [**getAdSetCategoryBids**](docs/Api/CampaignApi.md#getadsetcategorybids) | **GET** /2024-10/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**getCampaign**](docs/Api/CampaignApi.md#getcampaign) | **GET** /2024-10/marketing-solutions/campaigns/{campaign-id} | 
...
*CampaignApi* | [**patchAdSetCategoryBids**](docs/Api/CampaignApi.md#patchadsetcategorybids) | **PATCH** /2024-10/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**patchAdSets**](docs/Api/CampaignApi.md#patchadsets) | **PATCH** /2024-10/marketing-solutions/ad-sets | 
...
*CampaignApi* | [**searchAdSets**](docs/Api/CampaignApi.md#searchadsets) | **POST** /2024-10/marketing-solutions/ad-sets/search | 
*CampaignApi* | [**searchCampaigns**](docs/Api/CampaignApi.md#searchcampaigns) | **POST** /2024-10/marketing-solutions/campaigns/search | 
