...
- Package version: 2022.07.0.230405
...
either run the following command: `composer require criteo/criteo-api-marketingsolutions-sdk:2022.07.0.230405`
...
$apiInstance = new criteo\api\marketingsolutions\v2022_07\Api\AdvertiserApi(new criteo\api\marketingsolutions\v2022_07\TokenAutoRefreshClient($clientId, $clientSecret));
...
------------ | ------------- | ------------- | -------------
*AdvertiserApi* | [**apiPortfolioGet**](docs/Api/AdvertiserApi.md#apiportfolioget) | **GET** /2022-07/advertisers/me | 
*AnalyticsApi* | [**getAdsetReport**](docs/Api/AnalyticsApi.md#getadsetreport) | **POST** /2022-07/statistics/report | 
*AnalyticsApi* | [**getPlacementsReport**](docs/Api/AnalyticsApi.md#getplacementsreport) | **POST** /2022-07/placements/report | 
*AnalyticsApi* | [**getTransactionsReport**](docs/Api/AnalyticsApi.md#gettransactionsreport) | **POST** /2022-07/transactions/report | 
*AnalyticsApi* | [**getTransparencyReport**](docs/Api/AnalyticsApi.md#gettransparencyreport) | **POST** /2022-07/log-level/advertisers/{advertiser-id}/report | 
*AudienceApi* | [**createAudience**](docs/Api/AudienceApi.md#createaudience) | **POST** /2022-07/audiences | 
*AudienceApi* | [**deleteIdentifiers**](docs/Api/AudienceApi.md#deleteidentifiers) | **DELETE** /2022-07/audiences/{audience-id}/contactlist | 
*AudienceApi* | [**getAudiences**](docs/Api/AudienceApi.md#getaudiences) | **GET** /2022-07/audiences | 
*AudienceApi* | [**modifyAudience**](docs/Api/AudienceApi.md#modifyaudience) | **PATCH** /2022-07/audiences/{audience-id} | 
*AudienceApi* | [**modifyAudienceUsers**](docs/Api/AudienceApi.md#modifyaudienceusers) | **PATCH** /2022-07/audiences/{audience-id}/contactlist | 
*AudienceApi* | [**removeAudience**](docs/Api/AudienceApi.md#removeaudience) | **DELETE** /2022-07/audiences/{audience-id} | 
*CampaignApi* | [**getAdSet**](docs/Api/CampaignApi.md#getadset) | **GET** /2022-07/marketing-solutions/ad-sets/{adSetId} | 
*CampaignApi* | [**getCampaign**](docs/Api/CampaignApi.md#getcampaign) | **GET** /2022-07/marketing-solutions/campaigns/{campaign-id} | 
*CampaignApi* | [**getCategoryBidList**](docs/Api/CampaignApi.md#getcategorybidlist) | **GET** /2022-07/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**getDisplayMultipliers**](docs/Api/CampaignApi.md#getdisplaymultipliers) | **GET** /2022-07/marketing-solutions/ad-sets/{ad-set-id}/display-multipliers | 
*CampaignApi* | [**patchAdSets**](docs/Api/CampaignApi.md#patchadsets) | **PATCH** /2022-07/marketing-solutions/ad-sets | 
*CampaignApi* | [**patchCampaigns**](docs/Api/CampaignApi.md#patchcampaigns) | **PATCH** /2022-07/marketing-solutions/campaigns | 
*CampaignApi* | [**patchCategoryBidList**](docs/Api/CampaignApi.md#patchcategorybidlist) | **PATCH** /2022-07/marketing-solutions/ad-sets/{ad-set-id}/category-bids | 
*CampaignApi* | [**patchDisplayMultipliers**](docs/Api/CampaignApi.md#patchdisplaymultipliers) | **PATCH** /2022-07/marketing-solutions/ad-sets/{ad-set-id}/display-multipliers | 
*CampaignApi* | [**searchAdSets**](docs/Api/CampaignApi.md#searchadsets) | **POST** /2022-07/marketing-solutions/ad-sets/search | 
*CampaignApi* | [**searchCampaigns**](docs/Api/CampaignApi.md#searchcampaigns) | **POST** /2022-07/marketing-solutions/campaigns/search | 
*CampaignApi* | [**startAdSets**](docs/Api/CampaignApi.md#startadsets) | **POST** /2022-07/marketing-solutions/ad-sets/start | 
*CampaignApi* | [**stopAdSets**](docs/Api/CampaignApi.md#stopadsets) | **POST** /2022-07/marketing-solutions/ad-sets/stop | 
