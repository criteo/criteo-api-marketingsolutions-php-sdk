...
```php
patchAdSets($requests_patch_ad_set): \criteo\api\marketingsolutions\v2023_10\Model\ResponseAdSetId
```
...
[**\criteo\api\marketingsolutions\v2023_10\Model\ResponseAdSetId**](../Model/ResponseAdSetId.md)
