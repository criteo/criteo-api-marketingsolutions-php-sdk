# criteo\api\marketingsolutions\v2026_01\AnalyticsApi
...
| ------------- | ------------- | ------------- | ------------- |
| **statistics_report_query_message** | [**\criteo\api\marketingsolutions\v2026_01\Model\StatisticsReportQueryMessage**](../Model/StatisticsReportQueryMessage.md)|  | [optional] |
...
$placements_report_query_message_list_request = {"data":[{"type":"report","attributes":{"advertiserIds":"123,456,789","campaignIds":"111,222,333,444","adsetIds":"135,246,357,468","environment":"Web","placement":"MyPlacement","dimensions":["AdsetId","AdvertiserId","Placement"],"metrics":["Clicks","Displays","Cost"],"currency":"EUR","disclosed":false,"format":"csv","timezone":"Europe/Paris","startDate":"2026-01-02T00:00:00.0000000+02:00","endDate":"2026-01-05T00:00:00.0000000+02:00"}}]}; // \criteo\api\marketingsolutions\v2026_01\Model\PlacementsReportQueryMessageListRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **placements_report_query_message_list_request** | [**\criteo\api\marketingsolutions\v2026_01\Model\PlacementsReportQueryMessageListRequest**](../Model/PlacementsReportQueryMessageListRequest.md)|  | [optional] |
...
$transactions_report_query_message_list_request = {"data":[{"type":"report","attributes":{"advertiserIds":"123,456,789","eventType":"Display","currency":"EUR","format":"csv","timezone":"Europe/Paris","startDate":"2026-01-02T00:00:00.0000000+02:00","endDate":"2026-01-05T00:00:00.0000000+02:00"}}]}; // \criteo\api\marketingsolutions\v2026_01\Model\TransactionsReportQueryMessageListRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **transactions_report_query_message_list_request** | [**\criteo\api\marketingsolutions\v2026_01\Model\TransactionsReportQueryMessageListRequest**](../Model/TransactionsReportQueryMessageListRequest.md)|  | [optional] |
...
```php
getTransparencyReport($advertiser_id, $transparency_query_message): \criteo\api\marketingsolutions\v2026_01\Model\TransparencyReportListResponse
```
...
$transparency_query_message = {"shouldDisplayProductIds":false,"startDate":"2025-08-11T00:00:00.0000000+00:00","endDate":"2025-08-14T00:00:00.0000000+00:00"}; // \criteo\api\marketingsolutions\v2026_01\Model\TransparencyQueryMessage | The query message.
...
| **transparency_query_message** | [**\criteo\api\marketingsolutions\v2026_01\Model\TransparencyQueryMessage**](../Model/TransparencyQueryMessage.md)| The query message. | [optional] |

### Return type

[**\criteo\api\marketingsolutions\v2026_01\Model\TransparencyReportListResponse**](../Model/TransparencyReportListResponse.md)
