# criteo\api\marketingsolutions\experimental\AnalyticsApi
...
```php
createRealtimeProductReport($real_time_product_report_job_request): \criteo\api\marketingsolutions\experimental\Model\RealTimeProductReportJobStatusResponse
```
...
$real_time_product_report_job_request = new \criteo\api\marketingsolutions\experimental\Model\RealTimeProductReportJobRequest(); // \criteo\api\marketingsolutions\experimental\Model\RealTimeProductReportJobRequest | The realtime report export request.
...
| ------------- | ------------- | ------------- | ------------- |
| **real_time_product_report_job_request** | [**\criteo\api\marketingsolutions\experimental\Model\RealTimeProductReportJobRequest**](../Model/RealTimeProductReportJobRequest.md)| The realtime report export request. | [optional] |

### Return type

[**\criteo\api\marketingsolutions\experimental\Model\RealTimeProductReportJobStatusResponse**](../Model/RealTimeProductReportJobStatusResponse.md)
...
$statistics_report_query_message = {"advertiserIds":"123,456,789","adSetIds":["12345","54321"],"adSetNames":["myAdSet1","myAdSet2"],"adSetStatus":["Active"],"dimensions":["CampaignId","Campaign","AdsetId","Adset","AdvertiserId","Advertiser","AdId","Ad","CouponId","Coupon","CategoryId","Category","Hour","Day","Week","Month","Year","Os","Device"],"metrics":["Clicks","Displays","Cpc","Visits"],"currency":"EUR","format":"csv","timezone":"Europe/Paris","startDate":"2026-03-13T00:00:00.0000000+00:00","endDate":"2026-03-16T00:00:00.0000000+00:00"}; // \criteo\api\marketingsolutions\experimental\Model\StatisticsReportQueryMessage
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **statistics_report_query_message** | [**\criteo\api\marketingsolutions\experimental\Model\StatisticsReportQueryMessage**](../Model/StatisticsReportQueryMessage.md)|  | [optional] |
...
```php
getAsyncAdsetReport($generate_statistics_report_request): \criteo\api\marketingsolutions\experimental\Model\MarketingSolutionsReportStatusResponse
```
...
$generate_statistics_report_request = new \criteo\api\marketingsolutions\experimental\Model\GenerateStatisticsReportRequest(); // \criteo\api\marketingsolutions\experimental\Model\GenerateStatisticsReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_statistics_report_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateStatisticsReportRequest**](../Model/GenerateStatisticsReportRequest.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\experimental\Model\MarketingSolutionsReportStatusResponse**](../Model/MarketingSolutionsReportStatusResponse.md)
...
```php
getAsyncAudienceReport($generate_audience_performance_report_request): \criteo\api\marketingsolutions\experimental\Model\MarketingSolutionsReportStatusResponse
```
...
$generate_audience_performance_report_request = new \criteo\api\marketingsolutions\experimental\Model\GenerateAudiencePerformanceReportRequest(); // \criteo\api\marketingsolutions\experimental\Model\GenerateAudiencePerformanceReportRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_audience_performance_report_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateAudiencePerformanceReportRequest**](../Model/GenerateAudiencePerformanceReportRequest.md)|  | [optional] |
...
```php
getAsyncExportOutput($report_id): \criteo\api\marketingsolutions\experimental\Model\ExportResult
```
...
[**\criteo\api\marketingsolutions\experimental\Model\ExportResult**](../Model/ExportResult.md)
...
```php
getAsyncExportStatus($report_id): \criteo\api\marketingsolutions\experimental\Model\MarketingSolutionsReportStatusResponse
```
...
$generate_categories_report_request_attributes_request = {"data":{"type":"GenerateCategoriesReport","attributes":{"advertiserIds":["123","456","789"],"campaignId":"111","adsetId":"135","domain":"example.com","category":"Example","shouldDisplayDomainDimension":true,"format":"csv","timezone":"Europe/Paris","startDate":"2026-03-13T00:00:00.0000000+00:00","endDate":"2026-03-16T00:00:00.0000000+00:00"}}}; // \criteo\api\marketingsolutions\experimental\Model\GenerateCategoriesReportRequestAttributesRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_categories_report_request_attributes_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateCategoriesReportRequestAttributesRequest**](../Model/GenerateCategoriesReportRequestAttributesRequest.md)|  | [optional] |
...
```php
getCreativesReport($generate_creatives_report_request_attributes_request): \criteo\api\marketingsolutions\experimental\Model\JsonReportRowsListResponse
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_creatives_report_request_attributes_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateCreativesReportRequestAttributesRequest**](../Model/GenerateCreativesReportRequestAttributesRequest.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\experimental\Model\JsonReportRowsListResponse**](../Model/JsonReportRowsListResponse.md)
...
```php
getExportStatus($report_id): \criteo\api\marketingsolutions\experimental\Model\ExportStatusModelResponse
```
...
[**\criteo\api\marketingsolutions\experimental\Model\ExportStatusModelResponse**](../Model/ExportStatusModelResponse.md)
...
$placements_report_query_message_list_request = {"data":[{"type":"report","attributes":{"advertiserIds":"123,456,789","campaignIds":"111,222,333,444","adsetIds":"135,246,357,468","environment":"Web","placement":"MyPlacement","dimensions":["AdsetId","AdvertiserId","Placement"],"metrics":["Clicks","Displays","Cost"],"currency":"EUR","disclosed":false,"format":"csv","timezone":"Europe/Paris","startDate":"2026-03-13T00:00:00.0000000+00:00","endDate":"2026-03-16T00:00:00.0000000+00:00"}}]}; // \criteo\api\marketingsolutions\experimental\Model\PlacementsReportQueryMessageListRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **placements_report_query_message_list_request** | [**\criteo\api\marketingsolutions\experimental\Model\PlacementsReportQueryMessageListRequest**](../Model/PlacementsReportQueryMessageListRequest.md)|  | [optional] |
...
```php
getRealtimeProduct($report_id): \criteo\api\marketingsolutions\experimental\Model\FileStreamResultResponse
```
...
[**\criteo\api\marketingsolutions\experimental\Model\FileStreamResultResponse**](../Model/FileStreamResultResponse.md)
...
```php
getRealtimeStatisticsReport($generate_realtime_statistics_report_request_attributes_request): \criteo\api\marketingsolutions\experimental\Model\JsonReportRowsListResponse
```
...
$generate_realtime_statistics_report_request_attributes_request = {"data":{"type":"GenerateRealtimeStatisticsReport","attributes":{"advertiserIds":["123","456"],"campaignIds":["111"],"adsetIds":["135"],"dimensions":["AdvertiserId","Advertiser","CampaignId","Campaign","AdsetId","Adset","Day","Hour"],"metrics":["Displays","Clicks","Cost"],"lookbackWindow":12,"currency":"EUR","timezone":"Europe/Paris"}}}; // \criteo\api\marketingsolutions\experimental\Model\GenerateRealtimeStatisticsReportRequestAttributesRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_realtime_statistics_report_request_attributes_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateRealtimeStatisticsReportRequestAttributesRequest**](../Model/GenerateRealtimeStatisticsReportRequestAttributesRequest.md)|  | [optional] |
...
```php
getTopProductsReport($generate_top_products_report_request_attributes_request): \criteo\api\marketingsolutions\experimental\Model\JsonReportRowsListResponse
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **generate_top_products_report_request_attributes_request** | [**\criteo\api\marketingsolutions\experimental\Model\GenerateTopProductsReportRequestAttributesRequest**](../Model/GenerateTopProductsReportRequestAttributesRequest.md)|  | |
...
$transactions_report_query_message_list_request = {"data":[{"type":"report","attributes":{"advertiserIds":"123,456,789","eventType":"Display","currency":"EUR","format":"csv","timezone":"Europe/Paris","startDate":"2026-03-13T00:00:00.0000000+00:00","endDate":"2026-03-16T00:00:00.0000000+00:00"}}]}; // \criteo\api\marketingsolutions\experimental\Model\TransactionsReportQueryMessageListRequest
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **transactions_report_query_message_list_request** | [**\criteo\api\marketingsolutions\experimental\Model\TransactionsReportQueryMessageListRequest**](../Model/TransactionsReportQueryMessageListRequest.md)|  | [optional] |
...
```php
getTransparencyReport($advertiser_id, $transparency_query_message): \criteo\api\marketingsolutions\experimental\Model\TransparencyReportListResponse
```
...
$transparency_query_message = {"shouldDisplayProductIds":false,"startDate":"2026-03-13T00:00:00.0000000+00:00","endDate":"2026-03-16T00:00:00.0000000+00:00"}; // \criteo\api\marketingsolutions\experimental\Model\TransparencyQueryMessage | The query message.
...
| **transparency_query_message** | [**\criteo\api\marketingsolutions\experimental\Model\TransparencyQueryMessage**](../Model/TransparencyQueryMessage.md)| The query message. | [optional] |

### Return type

[**\criteo\api\marketingsolutions\experimental\Model\TransparencyReportListResponse**](../Model/TransparencyReportListResponse.md)
