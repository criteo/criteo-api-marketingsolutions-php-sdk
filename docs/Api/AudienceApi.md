...
```php
deleteContactListByAudienceSegment($audience_segment_id): \criteo\api\marketingsolutions\v2025_04\Model\DeleteAudienceContactListResponse
```
...
```php
updateContactListByAudienceSegment($audience_segment_id, $contactlist_amendment_request): \criteo\api\marketingsolutions\v2025_04\Model\ModifyAudienceResponse
```
