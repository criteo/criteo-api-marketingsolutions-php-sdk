# criteo\api\marketingsolutions\v2024_01\CreativeApi
...
```php
createAdvertiserAd($advertiser_id, $resource_input_of_ad_write): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfAd
```
...
$apiInstance = new criteo\api\marketingsolutions\v2024_01\Api\CreativeApi(
...
$resource_input_of_ad_write = new \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfAdWrite(); // \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfAdWrite
...
| **resource_input_of_ad_write** | [**\criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfAdWrite**](../Model/ResourceInputOfAdWrite.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfAd**](../Model/ResourceOutcomeOfAd.md)
...
```php
createAdvertiserCoupon($advertiser_id, $resource_input_of_create_coupon): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCoupon
```
...
$advertiser_id = 'advertiser_id_example'; // string | The advertiser identifier.
$resource_input_of_create_coupon = new \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreateCoupon(); // \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreateCoupon
...
| ------------- | ------------- | ------------- | ------------- |
| **advertiser_id** | **string**| The advertiser identifier. | |
| **resource_input_of_create_coupon** | [**\criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreateCoupon**](../Model/ResourceInputOfCreateCoupon.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCoupon**](../Model/ResourceOutcomeOfCoupon.md)
...
```php
createAdvertiserCreative($advertiser_id, $resource_input_of_creative_write): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCreative
```
...
$advertiser_id = 'advertiser_id_example'; // string | The advertiser identifier.
$resource_input_of_creative_write = new \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreativeWrite(); // \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreativeWrite
...
| ------------- | ------------- | ------------- | ------------- |
| **advertiser_id** | **string**| The advertiser identifier. | |
| **resource_input_of_creative_write** | [**\criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfCreativeWrite**](../Model/ResourceInputOfCreativeWrite.md)|  | |

### Return type

[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCreative**](../Model/ResourceOutcomeOfCreative.md)
...
```php
editAdvertiserCoupon($advertiser_id, $id, $resource_input_of_update_coupon): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCoupon
```
...
$resource_input_of_update_coupon = new \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfUpdateCoupon(); // \criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfUpdateCoupon
...
| **resource_input_of_update_coupon** | [**\criteo\api\marketingsolutions\v2024_01\Model\ResourceInputOfUpdateCoupon**](../Model/ResourceInputOfUpdateCoupon.md)|  | |
...
```php
editCreative($id, $resource_input_of_creative_write): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCreative
```
...
```php
getAd($id): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfAd
```
...
```php
getAdvertiserAds($advertiser_id, $limit, $offset): \criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfAd
```
...
[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfAd**](../Model/ResourceCollectionOutcomeOfAd.md)
...
```php
getAdvertiserCoupon($advertiser_id, $id): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCoupon
```
...
```php
getAdvertiserCouponSupportedSizes($advertiser_id, $ad_set_id): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCouponSupportedSizes
```
...
[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCouponSupportedSizes**](../Model/ResourceOutcomeOfCouponSupportedSizes.md)
...
```php
getAdvertiserCoupons($advertiser_id, $limit, $offset): \criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfCoupon
```
...
[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfCoupon**](../Model/ResourceCollectionOutcomeOfCoupon.md)
...
```php
getAdvertiserCreatives($advertiser_id, $limit, $offset): \criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfCreative
```
...
[**\criteo\api\marketingsolutions\v2024_01\Model\ResourceCollectionOutcomeOfCreative**](../Model/ResourceCollectionOutcomeOfCreative.md)
...
```php
getCreative($id): \criteo\api\marketingsolutions\v2024_01\Model\ResourceOutcomeOfCreative
```
