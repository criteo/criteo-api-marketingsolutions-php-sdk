...
```php
getAdvertiserCreatives($advertiser_id, $limit, $offset): \criteo\api\marketingsolutions\v2025_07\Model\ResourceCollectionOutcomeOfCreative
```
...
[**\criteo\api\marketingsolutions\v2025_07\Model\ResourceCollectionOutcomeOfCreative**](../Model/ResourceCollectionOutcomeOfCreative.md)
