...
```php
getAdvertiserCreatives($advertiser_id, $limit, $offset): \criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative
```
...
[**\criteo\api\marketingsolutions\v2025_04\Model\ResourceCollectionOutcomeOfCreative**](../Model/ResourceCollectionOutcomeOfCreative.md)
