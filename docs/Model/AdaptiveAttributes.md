...
**logos** | [**\criteo\api\marketingsolutions\v2025_01\Model\ImageShape[]**](ImageShape.md) | Logo images uploaded on demostatic.criteo.com when deploying and then static.criteo.net |
