...
**branding_images** | [**\criteo\api\marketingsolutions\preview\Model\ShowcaseBrandingImage[]**](ShowcaseBrandingImage.md) | Branding images per shape (horizontal, vertical, square) displayed in the creative. | [optional]
...
**colors** | [**\criteo\api\marketingsolutions\preview\Model\ShowcaseColors**](ShowcaseColors.md) |  | [optional]
...
**logos** | [**\criteo\api\marketingsolutions\preview\Model\ShowcaseLogo[]**](ShowcaseLogo.md) | Logo images with their shape and URL. | [optional]
