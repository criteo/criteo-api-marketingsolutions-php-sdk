...
------------ | ------------- | ------------- | -------------
**budget_amount** | **float** | Maximum budget amount in the advertiser&#39;s currency per renewal period. Required non-null when capped. Must be null when uncapped. | [optional]
