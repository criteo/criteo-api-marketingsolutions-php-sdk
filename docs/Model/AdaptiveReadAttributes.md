...
**colors** | [**\criteo\api\marketingsolutions\v2025_10\Model\AdaptiveColors**](AdaptiveColors.md) |  | [optional]
...
**image_sets** | [**\criteo\api\marketingsolutions\v2025_10\Model\ImageSet[]**](ImageSet.md) | Multiple image sets, each image set consists of multiple images and a headline text. | [optional]
...
**logos** | [**\criteo\api\marketingsolutions\v2025_10\Model\ImageShape[]**](ImageShape.md) | Logo images uploaded on demostatic.criteo.com when deploying and then static.criteo.net | [optional]
**videos** | [**\criteo\api\marketingsolutions\v2025_10\Model\VideoDetail[]**](VideoDetail.md) | Multiple videos potentially in different shapes. | [optional]
