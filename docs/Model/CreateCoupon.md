...
**images** | [**\criteo\api\marketingsolutions\v2025_07\Model\CreateImageSlide[]**](CreateImageSlide.md) | List of slides containing the images as a base-64 encoded string |
