...
**images** | [**\criteo\api\marketingsolutions\v2024_04\Model\CreateImageSlide[]**](CreateImageSlide.md) | List of slides containing the images as a base-64 encoded string |
