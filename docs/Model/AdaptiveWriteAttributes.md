...
**image_sets_base64** | [**\criteo\api\marketingsolutions\v2024_07\Model\ImageSetBase64[]**](ImageSetBase64.md) | Multiple image sets, each image set consists of multiple images as a base-64 encoded string and a headline text. | [optional]
