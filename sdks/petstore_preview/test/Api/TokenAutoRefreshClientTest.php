...
use criteo\api\petstore\preview\TokenAutoRefreshClient;
...
class TokenAutoRefreshClientTest extends TestCase
{
    ...
    public function testDoesNotInterceptRequestWhenNoAuthorizationHeader()
    {
        ...
        $response = (new criteo\api\petstore\preview\Api\OAuthApi($mockClient))
            ->createToken($this->clientId, $this->clientSecret, $this->grantType);


        $this->assertInstanceOf('criteo\api\petstore\preview\Model\JwtModel', $response);
