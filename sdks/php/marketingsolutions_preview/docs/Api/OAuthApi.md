# criteo\api\marketingsolutions\preview\OAuthApi
...
```php
createToken($client_id, $client_secret, $grant_type): \criteo\api\marketingsolutions\preview\Model\JwtModel
```
...
[**\criteo\api\marketingsolutions\preview\Model\JwtModel**](../Model/JwtModel.md)
