...
```php
    require_once('/path/to/criteo-api-marketingsolutions-sdk-php/vendor/autoload.php');
```
...
$apiInstance = new criteo\api\marketingsolutions\v2021_10\Api\AdvertiserApi(new TokenAutoRefreshClient($clientId, $clientSecret));
