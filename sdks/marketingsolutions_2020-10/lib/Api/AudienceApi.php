...
class AudienceApi
{
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\NewAudienceRequest $new_audience_request new_audience_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\NewAudienceRequest $new_audience_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAudienceWithHttpInfo($new_audience_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\NewAudienceResponse',
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteIdentifiersWithHttpInfo($audience_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceContactListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAudiencesWithHttpInfo($advertiser_id = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\GetAudiencesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceRequest $replace_audience_request replace_audience_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceRequest $replace_audience_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyAudienceWithHttpInfo($audience_id, $replace_audience_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\ReplaceAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\ContactlistAmendmentRequest $contactlist_amendment_request contactlist_amendment_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     *
     * @param  string $audience_id The id of the audience to amend (required)
     * @param  \criteo\api\marketingsolutions\v2020_10\Model\ContactlistAmendmentRequest $contactlist_amendment_request (required)
     *
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyAudienceUsersWithHttpInfo($audience_id, $contactlist_amendment_request)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\ModifyAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse
     */
     ...
     * @throws \criteo\api\marketingsolutions\v2020_10\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse|\criteo\api\marketingsolutions\v2020_10\Model\ErrorCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeAudienceWithHttpInfo($audience_id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\criteo\api\marketingsolutions\v2020_10\Model\DeleteAudienceResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
